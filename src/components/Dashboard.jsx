  ...
  return (
    <div style={{position: 'fixed', top: '0', zIndex: '10000'}}>
      ...
      <div className="containerNavbar">
        <div>
          <a className="navbar-brand textNavbar" style={{fontSize: '1.2rem'}} href="#"><img src='images/portfolioImage1.jpg' className="navbarPhoto" />Guillermo ALfredo Fernández Martínez</a>
        </div>
