  ...
  return (
    <div style={{position: 'fixed', top: '0', zIndex: '10000', maxWidth: '100vw'}}>
      ...
      <div className="containerNavbar">
        <div>
          <a className="navbar-brand textNavbar" style={{fontSize: '1.2rem'}} href="#"><img src='images/portfolioImage1.jpg' className="navbarPhoto" /><span>Guillermo ALfredo Fernández Martínez</span></a>
        </div>
