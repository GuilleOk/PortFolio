    ...
    <div style={{ background: 'rgb(2, 48, 21)' }} className='footer'>
      <footer className="d-none d-lg-block pt-3 pb-1">
        ...
        <div className="d-flex justify-content-center align-items-center">
          <a href="mailto:guillermoafernandezmartinez@gmail.com" style={{textDecoration: 'none'}} className="text-center text-body-secondary mb-2">Contacto: <strong style={{ marginLeft: '.5rem', borderBottom: '.1rem solid white' }}>guillermoafernandezmartinez@gmail.com</strong></a>
      ...
      <footer className="d-block d-lg-none pt-3 pb-1">
        ...
        <div className="d-flex justify-content-evenly align-items-center">
          ...
          <a href='mailto:guillermoafernandezmartinez@gmail.com' style={{textDecoration: 'none'}} className="text-center text-body-secondary mb-0"><strong style={{ marginLeft: '.5rem', borderBottom: '.1rem solid white', fontSize: '.8rem' }}>guillermoafernandezmartinez@gmail.com</strong></a>
          <a href="https://www.linkedin.com/in/guillermo-alfredo-fernandez-martinez-a7a59128a" target="_blank" className="nav-link px-2 text-body-secondary">
            <img src="images/redes_sociales/linkedin.png" alt="linkedin" className="socialMediaPhotoFooter" />
          </a>
        </div>
